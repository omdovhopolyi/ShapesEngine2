...
namespace shen
{
    ...
    //sf::Transform Serialization::GetTransform(const std::string& id) const
    //{
    //    if (const auto child = _element->FirstChildElement(id.c_str()))
    //    {
    ...
    //void Serialization::ForAllChildren(const std::string& id, const std::string& elementId, const std::function<void(const DataElementWrapper&)>& func) const
    //{
    //    if (_element)
    //    {
    //        if (const auto child = _element->FirstChildElement(id.c_str()))
    ...
    //void Serialization::ForAllChildren(const std::string& elementId, const std::function<void(const DataElementWrapper&)>& func) const
    //{
    //    if (_element)
    //    {
    ...
    //void Serialization::ForAllChildren(const std::function<void(const DataElementWrapper&)>& func) const
    //{
    ...
    //void Serialization::ForAllChildren(tinyxml2::XMLElement* element, const std::function<void(const DataElementWrapper&)>& func) const
    //{
